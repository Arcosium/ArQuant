...
Let 5–15 accounts trade **concurrently and independently** from their own KIS/OpenRouter
...
per-user API rate-limit/cost ceilings (each user uses their own KIS/OpenRouter keys, so cost
