...
children.push(P("'전략' 탭에서 현재 적용 중인 모든 파라미터를 그룹별로 보고, 한국어 라벨·단위(%, 배, 일, 건)로 직접 수정해 '변경값 적용'을 누르면 즉시 라이브 반영됩니다."));
children.push(table(
...
children.push(P("각 항목은 현재 적용값이 입력칸에 그대로 표시됩니다. 수정 후 '변경값 적용'으로 라이브 오버라이드하거나, '되돌리기'로 현재 적용값을 다시 불러올 수 있습니다."));
...
children.push(table(
  ["에이전트", "역할"],
  [
    ["주식운용실장", "총괄 전략·종목 선정(2패스: 후보 5개 → 최종 N개) · 사장 지시 처리"],
    ["글로벌리서치팀장", "거시·매크로 분석, 주식/현금 비중 권고"],
